...
- [ ] Content rating questionnaire (IARC) - user-to-user chat counts as UGC
- [ ] Target audience (13+ suggested; avoid Kids/Families program), Ads = none
- [ ] Decide android:allowBackup (currently true) and reflect in answers
- [ ] News app / COVID / gov declarations = No; Advertising ID = No (verify)
