...
| 2 | Release keystore + signing config | 02_signing | [ ] |
| 3 | Version bump + release .aab | 03_release_build | [ ] |
| 4 | 16KB page-size check | 04_16kb_check | [ ] |
| 5 | Play Console developer account | 05_play_account | [ ] |
...
Secrets: keystore + passwords live in ~/rampart_secrets/ (outside the repo, backed up).
